...
def predict(images_dir, model_dir, bottlenecks_dir, input_layer_name, output_layer_name):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--graph",
        type=str,
        default=path + model_name + "/retrained_graph.pb",
    ...
    parser.add_argument(
        "--bottlenecks_dir",
        type=str,
        default=path + model_name + "/bottlenecks",
        help="Path to store bottleneck layer values."
    )
    parser.add_argument(
        "--labels",
        type=str,
        default=path + model_name + "/output_labels.txt",
